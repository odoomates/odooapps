...
var ServiceChargeButton = screens.ActionButtonWidget.extend({
    ...
    button_click: function(){
        ...
        if (service_amount_type == 'amount'){
            this.gui.show_popup('number',{
                ...
                'value': this.pos.config.tax_return_charge,
    ...
    apply_service_charge: function(pc) {
        ...
        var product  = this.pos.db.get_product_by_id(this.pos.config.tax_return_product_id[0]);
...
//        }
        ...
        if( service_charge > 0 ){
            order.add_product(product, { price: service_charge, quantity: -1 });
        }
    },
});
...
screens.define_action_button({
    ...
    'condition': function(){
        return this.pos.config.enable_tax_return && this.pos.config.tax_return_product_id;
    },
});

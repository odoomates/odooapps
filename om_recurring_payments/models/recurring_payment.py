...
class RecurringPaymentLine(models.Model):
    ...
    def action_create_payment(self):
        if self.recurring_payment_id.payment_type == 'outbound':
            payment_method_id = self.env.ref("account.account_payment_method_manual_out")
        else:
            payment_method_id = self.env.ref("account.account_payment_method_manual_in")
        vals = {
            ...
            'payment_reference': self.recurring_payment_id.name,
            'partner_id': self.partner_id.id,
